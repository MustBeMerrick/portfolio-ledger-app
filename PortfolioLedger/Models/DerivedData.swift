...
struct LedgerOutput {
    ...
    /// Equity transactions auto-generated by the engine (e.g. from option assignment).
    /// Not stored in the data store — derived each time the ledger is recomputed.
    var syntheticTransactions: [Transaction]
